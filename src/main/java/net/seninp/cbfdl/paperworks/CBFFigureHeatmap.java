...
public class CBFFigureHeatmap {
  ...
  public static void main(String[] args) throws NumberFormatException, IOException, SAXException {
    ...
    PrintWriter writer = new PrintWriter(new File("src/resources/data/CBF/CBF_TRAIN_shingled.txt"), "UTF-8");
    ...
    for (String k : keys) {
      ...
      writer.print(line.deleteCharAt(line.length() - 1) + SEPARATOR + k + CR);
    }
